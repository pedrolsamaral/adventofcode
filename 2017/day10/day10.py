...
INPUT_ARRAY = [88, 88, 211, 106, 141, 1, 78,
               254, 2, 111, 77, 255, 90, 0, 54, 205]
INPUT_STRING = "88,88,211,106,141,1,78,254,2,111,77,255,90,0,54,205"
print("Part 1")
print(calculate_simple_hash(INPUT_ARRAY, initialize_array(256), 0, 0))
print("Part 2")
print(calculate_full_hash(INPUT_STRING, initialize_array(256)))
